...
const DATA = {
  ...
  sections: [
      ...
      places: [
        {
          ...
          info: {
            ...
            팁: [
              ...
              "KE461 18:20 출발 → 21:05 도착, 22:00 체크인 예정",
            ],
    ...
    /* Day 2: ‘오행산+저녁’으로 변경 */
    {
      ...
      category: "DAY 2",
      icon: "mountainSnow",
      title: "9/6(토) – 오행산 • 마담 란 • 용다리 불쇼",
      places: [
        {
          name: "오행산 (Marble Mountains)",
          address: "Da Nang (그랩 25–30분)",
          info: {
        ...
        {
          name: "마담 란 (저녁, 18:00 예약)",
          address: "다낭 시내",
          info: {
            입장료: "식사비만",
            팁: ["미슐랭 등재 인기 레스토랑 → 사전 예약 권장 (예약: 선권)"],
            챙길것: ["예약확인", "소액 현금", "물티슈"],
          },
        },
        {
          name: "한강 유람선 & 용다리 불쇼 (20:15 탑승)",
          address: "Han River",
          info: {
            입장료: "유람선 요금 별도 (예약 완료)",
            팁: ["강바람 → 얇은 겉옷 지참", "라스트 보트 시간 확인"],
    ...
    /* Day 4: ‘바나힐 + 선짜 야시장’으로 변경 */
    {
      id: "day4-marble",
      category: "DAY 4",
      icon: "mountain",
      title: "9/8(월) – 바나힐 • 비어플라자 • 선짜 야시장",
      places: [
        {
        ...
        },
        {
          ...
          info: {
            입장료: "식사비만",
            팁: ["피자 등 간단한 메뉴, 혼잡 시간대 좌석 선점"],
            챙길것: ["식전/식후 수분 보충", "카드/현금"],
          },
        },
        {
          name: "선짜 야시장",
...

    {
      ...
      places: [
        ...
        },
        {
          ...
          info: {
            입장료: "무료 (구매비 별도)",
            팁: ["커피/과자 등 기념품 쇼핑 적합", "체크아웃 후 짐 동선 고려"],
